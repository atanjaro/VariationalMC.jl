```@meta
EditURL = "../../../examples/hubbard_square.jl"
```

# Hubbard Square
Download this example as a [Julia script](../assets/scripts/examples/hubbard_square.jl).

This is a ready-to-run script for simulating a two-dimensional (2D) Hubbard model
on a square lattice with an onsite $s$-wave pairing wavefunction.
