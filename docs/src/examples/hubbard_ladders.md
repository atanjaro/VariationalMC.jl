```@meta
EditURL = "../../../examples/hubbard_ladders.jl"
```

# Interacting Hubbard Ladders
Download this example as a [Julia script](../assets/scripts/examples/hubbard_ladders.jl).

This is a ready-to-run script for simulating a two-dimensional (2D) Hubbard model
on a rectangular lattice goemetry (ladders) with a stripe wavefunction.
